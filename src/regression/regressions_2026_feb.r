...
setwd("g:/Saját meghajtó/Public transport in the 15-minutes city/regressions_2026_feb")

bp <- read.table("bp_indicators_with_ses.csv", header = T, sep = ",")
madrid <- read.table("madrid_indicators_with_ses.csv", header = T, sep = ",")
helsinki <- read.table("helsinki_indicators_with_ses.csv", header = T, sep = ",")
...
# 4.1 Coefficient plots into Main Text
...
bp_z <- transform(bp,
                  gini_diff = z(gini_diff),
                  gini_diff_house = z(gini_diff_house),
                  access_diff = z(access_diff),
                  gini_walk15 = z(gini_walk15),
                  walk_sum = z(walk_sum),
                  area_difference = z(area_difference),
                  ellipticity = z(ellipticity),
                  distance_betweenness = z(distance_betweenness))

helsinki_z <- transform(helsinki,
                        gini_diff = z(gini_diff),
                        access_diff = z(access_diff),
                        weighted_gini_walk = z(weighted_gini_walk),
                        walk_sum = z(walk_sum),
                        area_difference = z(area_difference),
                        ellipticity = z(ellipticity),
                        distance_betweenness = z(distance_betweenness))

madrid_z <- transform(madrid,
                      gini_diff = z(gini_diff),
                      access_diff = z(access_diff),
                      weighted_gini_walk = z(weighted_gini_walk),
                      walk_sum = z(walk_sum),
...
bp_avg_price=read.table("bp_stop_property_price.csv", header = T, sep=",")
bp_z=merge(bp_z, bp_avg_price, by="stop_id", all.x=T, all.y=F)
ls(bp_avg_price)
...
bp1_noint_l=lm(gini_diff ~
                 ...
                 ellipticity+
                 distance_betweenness,
               data=bp_z[bp_z$arpu_low_ratio_walk15>
                         median(bp_z$arpu_low_ratio_walk15),])
...
bp2_noint_l=lm(gini_diff_house ~
                 ...
                 ellipticity+
                 distance_betweenness,
               data=bp_z[bp_z$mean_price<
                         median(bp_z$mean_price, na.rm = T),])
...
helsinki1_noint_l=lm(gini_diff ~
                       ...
                       ellipticity+
                       distance_betweenness,
                     data=helsinki_z[helsinki_z$weighted_med_inc_walk<
                                     median(helsinki_z$weighted_med_inc_walk),])
...
madrid1_noint_l=lm(gini_diff ~
                     ...
                     ellipticity+
                     distance_betweenness,
                   data=madrid_z[madrid_z$weighted_net_income_hh_walk<
                                 median(madrid_z$weighted_net_income_hh_walk),])
...
# Generate decomposed coeff-plot
...
allModelFrame_a <- data.frame(rbind(
  area_helsinki1a_noint, area_madrid1a_noint, area_bp1a_noint,
  area_helsinki1a_noint_l, area_madrid1a_noint_l, area_bp1a_noint_l,
  area_helsinki1a_noint_h, area_madrid1a_noint_h, area_bp1a_noint_h,
...
# Save to file
ggsave("Fig_3C.png", plot = final_plot, width = 16, height = 8)
ggsave("Fig_3C.pdf", plot = final_plot, width = 16, height = 8)

# Gini
allModelFrame_g <- data.frame(rbind(
  area_helsinki1_noint, area_madrid1_noint, area_bp2_noint, area_bp1_noint,
  area_helsinki1_noint_l, area_madrid1_noint_l, area_bp2_noint_l, area_bp1_noint_l,
  area_helsinki1_noint_h, area_madrid1_noint_h, area_bp2_noint_h, area_bp1_noint_h,
...
# Save to file
ggsave("Fig_4C.png", plot = final_plot_gini, width = 16, height = 8)
ggsave("Fig_4C.pdf", plot = final_plot_gini, width = 16, height = 8)
...
ggsave("Fig_3-4C_legend_plot.png", plot = legend_plot, width = 8, height = 2.5)
ggsave("Fig_3-4C_legend_plot.pdf", plot = legend_plot, width = 8, height = 2.5)



# 4.2 Regressions with interactions into - standardized
...
# 4.6 Consider socio-economic status of walking area - interactions, standardized
...
stargazer(helsinki1a_h, madrid1a_h, bp1a_h,
          ...
          column.labels = c("Helsinki - Access",
                            ...
                            "BP experienced - Gini"),
          dep.var.labels.include = F,
          out="SI_Reg_6_high.tex")



# 4.4 Interplots - non-standardized
...
p<-interplot(m = bp1i, var1 = "ellipticity", var2 = "distance_betweenness", hist=FALSE, point =T,
          steps = 30,
          esize = 2,
          ercolor = "black")+
...
ggsave("Fig4_interplot_bp1.png", p, width = 12, height = 12, dpi = 300)
ggsave("Fig4_interplot_bp1.pdf", p, width = 12, height = 12, device = cairo_pdf)

p<-interplot(m = bp2i, var1 = "ellipticity", var2 = "distance_betweenness", hist=FALSE, point =T,
          steps = 30,
          esize = 2,
          ercolor = "black")+
  # Change the background
...
ggsave("Fig4_interplot_bp2.png", p, width = 12, height = 12, dpi = 300)
ggsave("Fig4_interplot_bp2.pdf", p, width = 12, height = 12, device = cairo_pdf)


p<-interplot(m = helsinki1i, var1 = "ellipticity", var2 = "distance_betweenness", hist=FALSE, point =T,
          steps = 30,
          esize = 2,
          ercolor = "black")+
  # Change the background
...
ggsave("Fig4_interplot_helsinki.png", p, width = 12, height = 12, dpi = 300)
ggsave("Fig4_interplot_helsinki.pdf", p, width = 12, height = 12, device = cairo_pdf)


p<-interplot(m = madrid1i, var1 = "ellipticity", var2 = "distance_betweenness", hist=FALSE, point =T,
          steps = 30,
          esize = 2,
          ercolor = "black")+
  # Change the background
...
ggsave("Fig4_interplot_madrid.png", p, width = 12, height = 12, dpi = 300)
ggsave("Fig4_interplot_madrid.pdf", p, width = 12, height = 12, device = cairo_pdf)


p<-interplot(m = bp1ai, var1 = "ellipticity", var2 = "distance_betweenness", hist=FALSE, point =T,
          steps = 30,
          esize = 2,
          ercolor = "black")+
  # Change the background
...
ggsave("Fig3_interplot_bp.png", p, width = 12, height = 12, dpi = 300)
ggsave("Fig3_interplot_bp.pdf", p, width = 12, height = 12, device = cairo_pdf)


p<-interplot(m = helsinki1ai, var1 = "ellipticity", var2 = "distance_betweenness", hist=FALSE, point =T,
          steps = 30,
          esize = 2,
          ercolor = "black")+
  # Change the background
...
ggsave("Fig3_interplot_helsinki.png", p, width = 12, height = 12, dpi = 300)
ggsave("Fig3_interplot_helsinki.pdf", p, width = 12, height = 12, device = cairo_pdf)


p<-interplot(m = madrid1ai, var1 = "ellipticity", var2 = "distance_betweenness", hist=FALSE, point =T,
          steps = 30,
          esize = 2,
          ercolor = "black")+
  # Change the background
...
ggsave("Fig3_interplot_madrid.png", p, width = 12, height = 12, dpi = 300)
ggsave("Fig3_interplot_madrid.pdf", p, width = 12, height = 12, device = cairo_pdf)
