...
plot(
  bp$stop_lon[bp$distance_betweenness > quantile(bp$distance_betweenness, 0.25)],
  bp$stop_lat[bp$distance_betweenness > quantile(bp$distance_betweenness, 0.25)]
)

plot(
  madrid$stop_lon[madrid$distance_betweenness > quantile(madrid$distance_betweenness, 0.25)],
  madrid$stop_lat[madrid$distance_betweenness > quantile(madrid$distance_betweenness, 0.25)]
)

plot(
  helsinki$stop_lon[helsinki$distance_betweenness > quantile(helsinki$distance_betweenness, 0.25)],
...
bp2 <- lm(
  gini_house_multimodal - gini_house_walk15 ~
    # area+
    gini_walk15 +
    area_difference * ellipticity +
    distance_betweenness * ellipticity,
...
# List of model names (add or remove names as needed)
model_names <- c(
  "helsinki1a_s", "madrid1a_s", "bp1a_s",
...
interplot(
  m = bp1i, var1 = "ellipticity", var2 = "distance_betweenness", hist = FALSE, point = T,
  steps = 30,
  esize = 2,
  ercolor = "black"
) +
...
interplot(
  m = bp2i, var1 = "ellipticity", var2 = "distance_betweenness", hist = FALSE, point = T,
  steps = 30,
  esize = 2,
  ercolor = "black"
) +
...
interplot(
  m = helsinki1i, var1 = "ellipticity", var2 = "distance_betweenness", hist = FALSE, point = T,
  steps = 30,
  esize = 2,
  ercolor = "black"
) +
...
interplot(
  m = madrid1i, var1 = "ellipticity", var2 = "distance_betweenness", hist = FALSE, point = T,
  steps = 30,
  esize = 2,
  ercolor = "black"
) +
...
interplot(
  m = bp1ai, var1 = "ellipticity", var2 = "distance_betweenness", hist = FALSE, point = T,
  steps = 30,
  esize = 2,
  ercolor = "black"
) +
...
interplot(
  m = helsinki1ai, var1 = "ellipticity", var2 = "distance_betweenness", hist = FALSE, point = T,
  steps = 30,
  esize = 2,
  ercolor = "black"
) +
...
interplot(
  m = madrid1ai, var1 = "ellipticity", var2 = "distance_betweenness", hist = FALSE, point = T,
  steps = 30,
  esize = 2,
  ercolor = "black"
) +
...
vars_bp <- c(
  "access_diff", "gini_diff", "gini_diff_house", "walk_sum", "gini_walk15",
  "area_difference", "ellipticity", "distance_betweenness"
)
vars_he <- c(
  "access_diff", "gini_diff", "walk_sum", "weighted_gini_walk",
  "area_difference", "ellipticity", "distance_betweenness"
)
vars_ma <- c(
  "access_diff", "gini_diff", "walk_sum", "weighted_gini_walk",
...
stargazer(bp_sub,
  type = "latex", out = here("output/regression/", "SI_summary_bp.tex"),
  title = "Summary Statistics for Budapest",
  summary.stat = c("min", "p25", "median", "mean", "p75", "max", "sd")
)

stargazer(helsinki_sub,
  type = "latex", out = here("output/regression/", "SI_summary_helsinki.tex"),
  title = "Summary Statistics for Helsinki",
  summary.stat = c("min", "p25", "median", "mean", "p75", "max", "sd")
)

stargazer(madrid_sub,
  type = "latex", out = here("output/regression/", "SI_summary_madrid.tex"),
